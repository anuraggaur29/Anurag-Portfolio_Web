    ...
    <AppLayout title="Work Detail">
      <div className="container">
        ...
        <div className="mb-10 flex h-48 flex-col items-center justify-center">
          <h2 className="text-center text-3xl font-semibold sm:text-4xl">Want to build something like this?</h2>
          <p className="mt-4 text-center">I can help turn a project idea into a clean, responsive web experience.</p>
